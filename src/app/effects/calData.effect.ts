...
import { CalDataActionTypes, GetCalDataAction, GetCalDataSuccessAction,
    GetAllProjectionSnapshotAction, GetAllProjectionSnapshotActionSuccess,
        ...
        switchMap((action: GetCalDataAction) =>
            this.calDataService
                ...
                .pipe(
                    ...
                    catchError((e) => of({ type: 'Get Cal Data Error', error: e }))
                )
        )
    );
